...
news.areas << area_tw
news.user = user
news.title = '在使用中我發現了一些問題，如何反饋意見給你們？'
news.content = '您可在主頁的最下面找到"建議與反饋"的連結，提交反饋的方法就像發一篇新聞，但您不需要再去設定區域與屬性，只要填入您的意見即可。
<br><br>
HeyGo! Times(黑狗日報) 歡迎任何的批評與指教，我們會儘快處理您的反饋與意見，您可在主頁的下方找到"官方回覆"的連結。'
news.url = ''
news.area_string = ""
...
news.areas << area_tw
news.user = user
news.title = '我要去哪裡看 HeyGo! Times(黑狗日報) 的系統公告？'
...
news.areas << area_tw
news.user = user
news.title = '為什麼手機版上面沒有提供發佈新聞的功能？'
...
news.areas << area_tw
news.user = user
news.title = '為什麼手機版上的新聞內容長度這麼長？我想要留言時得一直移動畫面，很不方便耶！'
...
news.areas << area_tw
news.user = user
news.title = '手機的螢幕解析度比電腦螢幕差，你們如何讓使用者在手機上舒適的閱讀新聞？'
...
news.areas << area_tw
news.user = user
news.title = '我如何在手機上閱讀 HeyGo! Times(黑狗日報) 的新聞？'
...
news.areas << area_tw
news.user = user
news.title = '為什麼顯示新聞詳細內容時還要把原始網站上的廣告顯示出來？不能只顯示該新聞的內容和相片嗎？'
news.content = '基於尊重原始新聞網站的著作權，我們不能直接對原始新聞網頁的內容進行篩選，但我們已設法讓新聞內容出現在螢幕上最適合閱讀的位置，您可自己決定是否要閱讀新聞之外的內容。'
news.url = ""
news.area_string = ""
...
news.areas << area_tw
news.user = user
news.title = '既然你們不審查新聞，如何避免有不肖使用者放上不恰當的新聞內容（如色情廣告）？'
...
news.areas << area_tw
news.user = user
news.title = '我如何在發佈新聞時，把我拍攝的照片當做新聞照片？'
...
news.areas << area_tw
news.user = user
news.title = '為什麼我在發佈新聞時，已經貼上新聞的網址，新聞的內容不會自動填上對話框裡的表格？'
news.content = '當您輸入完新聞網址後，您還必須按下右上方的"取得新聞"按鈕，系統需要2~3秒去取得新聞內容與照片的網址。'
news.url = ""
news.area_string = ""
...
news.areas << area_tw
news.user = user
news.title = '我可以篩選出我的所有朋友看過的新聞，為什麼不能只選定看某個朋友感興趣的新聞？'
...
news.areas << area_tw
news.user = user
news.title = '我的朋友會看到哪些與我有關的新聞？'
news.content = '實際上 HeyGo! Times(黑狗日報) 並不會提供"可篩選出某個特定好友的所有行為" 的功能，使用者僅能篩選出他的所有朋友曾經：1. 閱讀過，2.評論過，3. 喜歡 的所有新聞。'
news.url = ""
news.area_string = ""
...
news.areas << area_tw
news.user = user
news.title = 'HeyGo! Times(黑狗日報) 中動態新聞排序的依據是什麼？'
...
news.areas << area_tw
news.user = user
news.title = '新聞這麼多，我如何找到我真正感興趣的新聞？'
...
news.areas << area_tw
news.user = user
news.title = 'HeyGo! Times(黑狗日報) 以後會支持其他社群網站（如twitter）的帳號嗎？'
...
news.areas << area_tw
news.user = user
news.title = '我沒有facebook帳號也可以使用 HeyGo! Times(黑狗日報) 的服務嗎？'
...
news.areas << area_tw
news.user = user
news.title = '為什麼 HeyGo! Times(黑狗日報) 不需要註冊？'
...
news.areas << area_tw
news.user = user
news.title = "HeyGo! Times(黑狗日報) 與一般新聞網站有什麼不同？"
...
news.areas << area_tw
news.user = user
news.title = "HeyGo! Times(黑狗日報) 提供哪些服務？"
